...
\begin{split}
  ...
  fighter = Entity('Arnold', Fighter, \\
    \langle str, int, dex \rangle,
    \langle sword, shield, boots \rangle, \\
    \langle f_{strbuff}, f_{intdebuff} \rangle,
    \langle f_{eqonlyfighter} \rangle, \\
    \langle incrStrBy5, incrHPBy7, decrInt \rangle)
\end{split}
\end{equation}
